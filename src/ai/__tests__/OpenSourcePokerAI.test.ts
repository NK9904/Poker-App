...
describe('OpenSourcePokerAI', () => {
  ...
  describe('analyzeSituation', () => {
    it('should return cached analysis if available', async () => {
      const firstAnalysis = await ai.analyzeSituation(mockPlayerCards, mockBoardCards, mockGameContext);
      const secondAnalysis = await ai.analyzeSituation(mockPlayerCards, mockBoardCards, mockGameContext);
  ...
  describe('getOptimalAction', () => {
    it('should return action with highest expected value', async () => {
      const action = await ai.getOptimalAction(mockPlayerCards, mockBoardCards, mockGameContext);
  ...
  describe('Model Metrics', () => {
    it('should track cache size correctly', async () => {
      await ai.analyzeSituation(mockPlayerCards, mockBoardCards, mockGameContext);
  ...
  describe('Cache Key Generation', () => {
    it('should generate consistent cache keys for same inputs', async () => {
      ...
      const analysis2 = await ai.analyzeSituation(mockPlayerCards, mockBoardCards, mockGameContext);
