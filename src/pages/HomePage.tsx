  ...
  const features = [
    {
      ...
      description:
        'Advanced GTO solver using open-source AI models for optimal poker strategy',
    ...
    },
    {
      ...
      description:
        'Immersive 3D interface with real-time poker move suggestions',
        ...
        <div className='container mx-auto px-4 py-20 lg:py-32'>
          ...
          >
            ...
            <p className='text-xl lg:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto'>
              Advanced GTO solver with 3D AI assistant. Get professional-level
              poker analysis using open-source AI models - no fees, no limits.
            </p>
      ...
      <section className='py-20 bg-gray-800/30'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience the future of poker analysis without the traditional
              costs
            </p>
          </motion.div>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-2xl mx-auto'>
              Join thousands of players who are already using AI to improve
              their game
            </p>
