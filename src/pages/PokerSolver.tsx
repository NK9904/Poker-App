...
const PokerSolver = memo(() => {
  ...
  const removeBoardCard = useCallback(
    (index: number) => {
  ...
  const handleGameContextChange = useCallback(
    (updates: Partial<typeof gameContext>) => {
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <div className='text-yellow-200/80 text-sm'>
                Using enhanced local analysis. Install Ollama for full AI
                capabilities.
              </div>
            </div>
          </div>
        ...
        >
          <GameContextControls
            ...
            onStackSizeChange={size =>
              handleGameContextChange({ stackSize: size })
            }
