...
export const useOpponentRange = () =>
  usePokerStore(state => state.opponentRange);
export const useLoading = () => usePokerStore(state => state.isLoading);
export const useLastCalculation = () =>
  usePokerStore(state => state.lastCalculation);

// Analysis selectors
export const useAnalysis = () => usePokerStore(state => state.analysis);
export const useHandEvaluation = () =>
  usePokerStore(state => state.analysis.handEvaluation);
...
export const useAIAnalysis = () =>
  usePokerStore(state => state.analysis.aiAnalysis);

// Game context selectors
export const useGameContext = () => usePokerStore(state => state.gameContext);
export const usePotSize = () =>
  usePokerStore(state => state.gameContext.potSize);
export const useStackSize = () =>
  usePokerStore(state => state.gameContext.stackSize);
export const usePosition = () =>
  usePokerStore(state => state.gameContext.position);
...
export const useAIAssistantVisible = () =>
  usePokerStore(state => state.aiAssistantVisible);
export const useSelectedAction = () =>
  usePokerStore(state => state.selectedAction);
