...
const AnalysisResults = memo(({ analysis, calculationTime }: AnalysisResultsProps) => {
        ...
        <div className="card" style={{ marginBottom: '2rem' }}>
                ...
                >
                  <div style={{ 
                    ...
                    <span style={{ 
                      ...
                      color: action.action === 'fold' ? 'var(--color-error)' :
                             action.action === 'raise' ? 'var(--color-success)' :
                             'var(--color-accent)'
                    }}>
                      {action.action}
                    </span>
                    <span style={{ 
                      ...
                      {action.confidence ? `${(action.confidence * 100).toFixed(1)}% confidence` : 'Recommended'}
                    </span>
                  </div>
                  ...
                  {action.expectedValue !== undefined && (
                    <div style={{ marginBottom: '0.5rem' }}>
                      <span style={{ 
                        color: action.expectedValue > 0 ? 'var(--color-success)' : 'var(--color-error)',
                        fontWeight: '500'
                      }}>
          ...
          <div style={{ 
            ...
            <span style={{ 
              fontSize: '1.125rem',
              fontWeight: '600',
              color: aiConfidence > 0.8 ? 'var(--color-success)' :
                     aiConfidence > 0.6 ? 'var(--color-warning)' :
                     'var(--color-error)'
            }}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ 
                ...
                <div style={{
                  ...
                  <div style={{ color: 'var(--color-success)', fontSize: '1.25rem', fontWeight: '600' }}>
                ...
                <div style={{
                  ...
                  <div style={{ color: 'var(--color-warning)', fontSize: '1.25rem', fontWeight: '600' }}>
                ...
                <div style={{
                  ...
                  <div style={{ color: 'var(--color-error)', fontSize: '1.25rem', fontWeight: '600' }}>
              ...
              <div style={{ 
                ...
                <div style={{
                  ...
                  <div style={{ 
                    fontSize: '1.125rem', 
                    fontWeight: '600',
                    color: analysis.gtoStrategy.expectedValue > 0 ? 'var(--color-success)' : 'var(--color-error)'
                  }}>
